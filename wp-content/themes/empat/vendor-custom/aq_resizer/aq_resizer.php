				...
				public function process( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
						try {
								...
								if ( ! $dims || ( ( ( null === $height && $orig_w == $width ) xor ( null === $width && $orig_h == $height ) ) xor ( $height == $orig_h && $width == $orig_w ) ) ) {
										...
										// "wp-smush-pro" webp support, generate WEBP image
										if( function_exists( 'imagewebp') && in_array( $ext, ['jpg', 'png', 'jpeg'] )) {
											...
											if( is_plugin_active( 'wp-smush-pro/wp-smush.php' ) ){
												...
												if( $ext == 'jpg' || $ext == 'jpeg' ) {
													$im = imagecreatefromjpeg( $destfilename );
												} else if( $ext == 'png' ) {
												...
												$webp_path = WP_CONTENT_DIR . "/smush-webp{$dst_rel_path}-{$suffix}.{$ext}.webp";

												if( ! file_exists( $webp_path ) ) {
													imagewebp( $im, $webp_path, 85 );
												} 
