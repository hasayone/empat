...
class frontend {
	...
	function load_scripts() {
		wp_register_script( 'empat-libs', get_template_directory_uri() . '/assets/js/libs.min.js', false, $this->_cache_time, true );

		wp_register_script( 'empat-lity', get_template_directory_uri() . '/assets/js/lity.min.js', false, $this->_cache_time, true );

		wp_register_script( 'empat-marquee', get_template_directory_uri() . '/assets/js/jquery.marquee.min.js', false, $this->_cache_time, true );
		$deps = [
			'jquery',
			'empat-libs',
			'empat-lity',
		...
		wp_register_script( 'empat-app', get_template_directory_uri() . '/assets/js/app.min.js', $deps, $this->_cache_time, true );
	...
	function load_styles() {
		wp_register_style( 'empat-app', get_template_directory_uri() . '/assets/css/app.min.css', false, $this->_cache_time );
